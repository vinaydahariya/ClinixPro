  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white w-[380px] p-8 rounded-xl shadow-lg text-center space-y-5">
        <h1 className="text-2xl font-bold text-green-600">Settlement Initiated</h1>
        <p className="text-gray-600">
          Your settlement amount will be transferred to your account within{" "}
          <span className="font-semibold">7-8 working days</span>.
        </p>
        <Link
          to="/clinic-dashboard/payment"
