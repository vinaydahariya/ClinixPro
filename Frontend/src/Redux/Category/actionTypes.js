...
export const GET_CATEGORIES_BY_CLINIC_REQUEST = "GET_CATEGORIES_BY_CLINIC_REQUEST";
export const GET_CATEGORIES_BY_CLINIC_SUCCESS = "GET_CATEGORIES_BY_CLINIC_SUCCESS";
export const GET_CATEGORIES_BY_CLINIC_FAILURE = "GET_CATEGORIES_BY_CLINIC_FAILURE";
